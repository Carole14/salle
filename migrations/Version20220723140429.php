 ...
 */
final class Version20220723140429 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE structures ADD CONSTRAINT FK_5BBEC55A98DE13AC FOREIGN KEY (partenaire_id) REFERENCES partenaire (id)');
